...
public class MMusingDandC9 {
    ...
    public static int[][] matrixMultiply(int[][] A, int[][] B) {
        ...
        int max = Math.max(Math.max(l1, h1), Math.max(l2, h2)); // Finding the maximum dimension of the matrices
        ...
        return matrixMultiplyDivideConquer(a, b); // Calling this function after padding so to avoid this repetition in recursive calls
    }
